...
void generate_data(Container<TKey, TData>* container, const int cmp_choice) {
			...
			if (choice_number == 1) //Tree case
			{
				...
				while (true)
				{
					...
					std::cout << "1. Name" << std::endl << "2. Content" << std::endl << "3. Weight" << std::endl
						<< "4. Price" << std::endl << "5. Deliver price" << std::endl << "6. Sender (from country)" << std::endl
